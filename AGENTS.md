...
- The backend (`api/server/index.js`) requires `client/dist/index.html` to exist even in dev mode. A placeholder is created automatically by the compose setup service.
